...
def generate_launch_description():
    ...
    if compiled == 'True':
        jetacker_ackermann_description_package_path = get_package_share_directory('jetacker_ackermann_description')
    else:
        jetacker_ackermann_description_package_path = '/home/ubuntu/ros2_ws/src/simulations/jetacker_ackermann_description'
    urdf_path = os.path.join(jetacker_ackermann_description_package_path, 'urdf/jetacker.xacro')
    rviz_config_file = os.path.join(jetacker_ackermann_description_package_path, 'rviz/view.rviz')
    ...
    rviz_launch = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(jetacker_ackermann_description_package_path, 'launch', 'rviz.launch.py')),
